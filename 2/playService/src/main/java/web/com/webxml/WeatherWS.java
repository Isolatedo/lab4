 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/IdeaProjects/playService/src/main/java/weatherWeb.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/IdeaProjects/playService/src/main/java/weatherWeb.wsdl");
